...
These were the most straightfoward choices to make, as we would not be able to 
...
If a UAV calls for charging, eventually the UAV will be serviced, at which point the robot will deliver power to the UAV until it receives the \textit{charging_complete} signal.
